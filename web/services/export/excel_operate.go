...
func (r *ExcelOperate) SetHeader(sheetName string, header []pojos.ExcelHeader) (p *ExcelOperate) {
...
func (r *ExcelOperate) judgeNeedWriterHeader(data *[]pojos.ExcelHeader) (res bool) {
	res = false
